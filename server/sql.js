const SQL_STATEMENTS = [
    ...
    "CREATE TABLE IF NOT EXISTS leaveSecurity (security VARCHAR(16), start VARCHAR(16), end VARCHAR(16), isaccepted VARCHAR(16))" ,
    "CREATE TABLE IF NOT EXISTS leaveHousekeeper (housekeeper VARCHAR(16), start VARCHAR(16), end VARCHAR(16), isaccepted VARCHAR(16))" ,
